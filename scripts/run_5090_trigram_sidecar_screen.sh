...
export CORE_AMP_PHASE="${CORE_AMP_PHASE:-5090_trigram_sidecar_screen}"
...
print_header() {
  echo "5090 trigram sidecar screen"
...
run_blocks1_seed() {
  ...
  local sidecar_spec_dir="${REPO_ROOT}/experiments/5090_architecture/_trigram_specs/blocks1_top${TRIGRAM_TOP_K}_${RUN_VERSION}"
  ...
  run_family_seed \
    ...
    "core_amp,5090,architecture,trigram_sidecar,screening,blocks1,${LEARNING_RATE_TAG}" \
...
run_blocks0_seed() {
  ...
  local sidecar_spec_dir="${REPO_ROOT}/experiments/5090_architecture/_trigram_specs/blocks0_top${TRIGRAM_TOP_K}_${RUN_VERSION}"
  ...
  run_family_seed \
    ...
    "core_amp,5090,architecture,trigram_sidecar,screening,blocks0,${LEARNING_RATE_TAG}" \
