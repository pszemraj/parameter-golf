...
pg_5090_require_serious_launcher_defaults() {
  ...
  pg_5090_expect_unset_or_empty "${script_name}" "LOCAL_BATCH_SIZE_OVERRIDE"
  pg_5090_expect_unset_or_empty "${script_name}" "BATCH_SIZE_OVERRIDE"
  pg_5090_expect_unset_or_empty "${script_name}" "SEQ_LEN_OVERRIDE"
  pg_5090_expect_unset_or_empty "${script_name}" "TARGET_STEP_TOKENS"
