...
def register_attention_branch_custom_op(
    ...
    def attention_branch_forward_op(
        ...
        y, softmax_lse, rng_state = fa2_forward_capture(q, k, v)
        return qkv, q, k, v, y, softmax_lse, rng_state
    ...
    def attention_branch_residual_op(
        ...
        qkv, q, k, v, y, softmax_lse, rng_state = attention_branch_forward_op(
            attn_in,
            qkv_weight_t,
            q_gain,
            cos,
