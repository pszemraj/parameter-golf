...
from model import GatedDeltaNet, HybridGPT, validate_gdn_w_g_optimizer  # noqa: E402
...
def run_gdn_eager() -> PreflightResult:
    ...
    layer = prepare_module(
        GatedDeltaNet(
            ...
            use_cuda_split_norm_lib=env_flag("GDN_USE_CUDA_SPLIT_NORM_LIB"),
...
def run_hybrid_case(*, compiled: bool) -> PreflightResult:
    ...
    base_model = prepare_module(
        HybridGPT(
            ...
            gdn_use_cuda_split_norm_lib=env_flag("GDN_USE_CUDA_SPLIT_NORM_LIB"),
