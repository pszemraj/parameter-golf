...
case "${SWEEP_PROFILE}" in
  ablate)
    DEFAULT_TRAIN_BATCH_TOKENS=131072
    DEFAULT_GRAD_ACCUM_STEPS=32
    DEFAULT_MAX_STEPS=1500
    DEFAULT_VAL_LOSS_EVERY=100
    DEFAULT_MAX_WALLCLOCK_SECONDS=180
