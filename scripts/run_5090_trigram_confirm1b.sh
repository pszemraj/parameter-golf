...
CORE_AMP_PHASE="${CORE_AMP_PHASE:-5090_trigram_confirm1b}"
...
VAL_EVERY="${VAL_EVERY:-512}"
VAL_STEPS="${VAL_STEPS:-8}"
FULL_VAL_FINAL="${FULL_VAL_FINAL:-1}"
LOG_EVERY="${LOG_EVERY:-128}"
LOG_STATE_EVERY="${LOG_STATE_EVERY:-512}"
SAVE_EVERY="${SAVE_EVERY:-4096}"
