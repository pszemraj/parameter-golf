...
_ARG_MAP: dict[str, tuple[str, str]] = {
    ...
    "trigram_top_k": ("model", "trigram_top_k"),
    "trigram_smoothing": ("model", "trigram_smoothing"),
    "trigram_residual_clip": ("model", "trigram_residual_clip"),
    "trigram_confidence_count_cap": ("model", "trigram_confidence_count_cap"),
    "trigram_max_tokens": ("model", "trigram_max_tokens"),
