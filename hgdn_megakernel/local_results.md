# Archived Full-Block HGDN Megakernel Local Results

The active performance path is the packed HGDN stack. Archived core-kernel
...
Follow-up core-kernel and packed-path notes moved out of this file:

- archived core-kernel checklist:
  [../docs/HGDN_CORE_KERNEL_PLAN.md](../docs/HGDN_CORE_KERNEL_PLAN.md)
- packed replay fairness audit:
  [../docs/HGDN_PACKED_DRIFT_AUDIT.md](../docs/HGDN_PACKED_DRIFT_AUDIT.md)
- chronology and H100 checkpoints:
