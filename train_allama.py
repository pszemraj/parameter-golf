...
class Hyperparameters:
    ...
    cast_linears: bool
    attn_impl: str
    attn_prep_kernel: str
    attn_outproj_kernel: str
    mlp_kernel: str
...
def main() -> None:
    ...
    log(
        ...
        f"q_gain_init={args.q_gain_init} attn_impl={args.attn_impl} "
        f"attn_prep_kernel={args.attn_prep_kernel} attn_outproj_kernel={args.attn_outproj_kernel} "
        f"mlp_kernel={args.mlp_kernel} simple_layer_modulation=1 "
