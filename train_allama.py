...
class Hyperparameters:
    ...
    def from_env(cls, cli: Optional[CliOverrides] = None) -> "Hyperparameters":
        ...
        return cls(
            ...
            attn_kernel=os.environ.get("ATTN_KERNEL", "pytorch"),
...
def main() -> None:
    ...
    log(
        ...
        f"q_gain_init={args.q_gain_init} attn_kernel={args.attn_kernel} mlp_kernel={args.mlp_kernel} simple_layer_modulation=1 "
